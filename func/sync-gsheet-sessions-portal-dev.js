...
async function syncGSheetPortalSessionsDev () {
    try {
        await syncGSheet();
    }
    catch (error) {
...
module.exports.executeSyncGSheetPortalSessionsDev = function() {
    syncGSheetPortalSessionsDev()
    .then(() => {
        // Call succeeded, set next timeout
        setTimeout(module.exports.executeSyncGSheetPortalSessionsDev, 60 * 1000);
    })
    .catch((error) => {
